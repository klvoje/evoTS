...
#'
#'@param SE.r standard error of the r parameter from the hessian (optional)
#'
...
#'
as.evoTS.multi.BW.acceldecel.fit<-function (modelName, logL, ancestral.values, r, SE.r, R, SE.R, method, K, n, iter)
{
  ic <- paleoTS::IC(logL = logL, K = K, n = n, method = "AICc")
  y <- list(modelName = modelName, logL = logL, AICc = ic, ancestral.values = ancestral.values, r = r, SE.r = SE.r, R = R, SE.R = SE.R,
