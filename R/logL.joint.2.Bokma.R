...
#'
#' @description Returns log-likelihood for a the Bokma model with two punctuations.
#'
...
logL.joint.2.Bokma<-function (p, y, gg)
{
  ...
  n.2 <- unname(table(gg)[2])
  n.3 <- unname(table(gg)[3])
