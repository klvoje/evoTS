...
#'
#' @description Returns log-likelihood for a model with an Unbiased Random Walk in the first segment, an Unbiased Random Walk in the second segment, and an Unbiased Random Walk in the third segment.
#'
