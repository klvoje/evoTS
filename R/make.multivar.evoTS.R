...
make.multivar.evoTS<-function (evoTS.1=NULL, evoTS.2=NULL, evoTS.3=NULL, evoTS.4=NULL, evoTS.5=NULL, evoTS.6=NULL, evoTS.7=NULL, evoTS.8=NULL, evoTS.9=NULL, evoTS.10=NULL){
  ...
  if(number.of.traits ==5)  {
    ...
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt)
  }

  if(number.of.traits ==6)  {
    xx<-cbind(all.data[[1]]$mm, all.data[[2]]$mm, all.data[[3]]$mm, all.data[[4]]$mm, all.data[[5]]$mm, all.data[[6]]$mm)
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv, all.data[[6]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn, all.data[[6]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt, all.data[[6]]$tt)
  }
  ...
  if(number.of.traits ==7)  {
    ...
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv, all.data[[6]]$vv, all.data[[7]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn, all.data[[6]]$nn, all.data[[7]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt, all.data[[6]]$tt, all.data[[7]]$tt)
  }
  ...
  if(number.of.traits ==8)  {
    ...
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv, all.data[[6]]$vv, all.data[[7]]$vv, all.data[[8]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn, all.data[[6]]$nn, all.data[[7]]$nn, all.data[[8]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt, all.data[[6]]$tt, all.data[[7]]$tt, all.data[[8]]$tt)
  }
  ...
  if(number.of.traits ==9)  {
    ...
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv, all.data[[6]]$vv, all.data[[7]]$vv, all.data[[8]]$vv, all.data[[9]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn, all.data[[6]]$nn, all.data[[7]]$nn, all.data[[8]]$nn, all.data[[9]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt, all.data[[6]]$tt, all.data[[7]]$tt, all.data[[8]]$tt, all.data[[9]]$tt)
  }
  ...
  if(number.of.traits ==10)  {
    ...
    vv<-cbind(all.data[[1]]$vv, all.data[[2]]$vv, all.data[[3]]$vv, all.data[[4]]$vv, all.data[[4]]$vv, all.data[[6]]$vv, all.data[[7]]$vv, all.data[[8]]$vv, all.data[[9]]$vv, all.data[[10]]$vv)
    nn<-cbind(all.data[[1]]$nn, all.data[[2]]$nn, all.data[[3]]$nn, all.data[[4]]$nn, all.data[[4]]$nn, all.data[[6]]$nn, all.data[[7]]$nn, all.data[[8]]$nn, all.data[[9]]$nn, all.data[[10]]$nn)
    tt<-cbind(all.data[[1]]$tt, all.data[[2]]$tt, all.data[[3]]$tt, all.data[[4]]$tt, all.data[[4]]$tt, all.data[[6]]$tt, all.data[[7]]$tt, all.data[[8]]$tt, all.data[[9]]$tt, all.data[[10]]$tt)
  }
